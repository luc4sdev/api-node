...
import { z } from 'zod'
import { getClientElastic } from "./controllers/client/get-client/get-client-elastic";
import { getAllClientsElastic } from "./controllers/client/get-all-clients/get-all-clients-elastic";
import { getAddressElastic } from "./controllers/address/get-address/get-address-elastic";
import { getAllRoutersElastic } from "./controllers/router/get-all-routers/get-all-routers-elastic";
import { getRouterElastic } from "./controllers/router/get-router/get-router-elastic";
...
export async function appRoutes(app: FastifyInstance) {
    ...
    app.withTypeProvider<ZodTypeProvider>().get(
        ...
        }, getAllClientsElastic)


    app.withTypeProvider<ZodTypeProvider>().get(
        '/elastic/address/:addressId',
        {
            schema: {
                tags: ['Elasticsearch'],
                summary: 'Get address',
    ...
    app.withTypeProvider<ZodTypeProvider>().get(
        ...
        }, getAllRoutersElastic)


    app.withTypeProvider<ZodTypeProvider>().get(
        '/elastic/router/:routerId',
        {
            schema: {
                tags: ['Elasticsearch'],
                summary: 'Get router',
